...
![](/images/post1/first-day-brba.gif)
{: refdef}
...
{:refdef: style="text-align: center;"}
![](/images/post1/wingardium-leviosa.gif)
{: refdef}
...
{:refdef: style="text-align: center;"}
![](/images/post1/uhf-rfid-reader-bd.jpg)
{: refdef}
...
![](/images/post1/microstrip_air_core.jpg) | ![](/images/post1/patch_ceramic.png) | ![](/images/post1/quadrifilar-2.png)
|------------------------------------|--------------------------------|--------------------------------|
...
![](/images/post1/dipole_1.png) | ![](/images/post1/4arm_dipole_tag.jpg) | ![](/images/post1/metal_tag.png)
|-------------------------|----------------------------------|---------------------------|
